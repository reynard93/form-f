<template>
    <mom-page-header  sticky-subheader data-qa="page_header" :user-name="loginDisplay.loginFullName"
        :company-name="loginDisplay.companyName" :branch-name="loginDisplay.branchName"
        :company-uen="loginDisplay.uenDivBranch" :title="title || ''" :allow-logout="hasLogoutButton"
        :allow-save="allowSave" :has-save-button="hasSaveButton" :last-saved-time="lastSavedTime" :breadcrumb="breadCrumb"
        @save="onSave" @logout="onLogout">
...
import linkHelpers, {type GetBreadCrumbProps, type BreadCrumbUrls } from '../../exports/helpers/link'
...
const subtitleCommaToggle = (idx: number): String =>  idx < subtitleInfo.value.length - 1 ? ',' : ''
